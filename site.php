...
<html>
    ...
    <!--------------------------------------HEADER------------------------------------------>
		<nav align="right" style="text-align: right;">
            <input style="font-size: 15px; border-radius: 4px;" type="search" placeholder="Search..." /> Welcome <b>Me</b>
  		</nav>
    <!--------------------------------------CONTENT------------------------------------------>
		<div class="cont" id="cont">
  				<div id="home">
					...
					function eX($amount, $from, $to){
						...
						if ($result->success) {
							return round($result->rate, 4);
						}
					}
					?>
					<p>Today<b><?php echo date('l jS \of F Y');?></b><br>
					<div>
						<div class="block" style="width: 38%;">
							...
							<form id="form1" runat="server">
								Enter Amount: <input id="amount" maxlength="12" size="5" value="1" /><br><br>
								From: <select id="from">
						...
						<div class="block" style="width: 38%;">
							<b>Buying</b><br>
							<br>1 USD =<b><?php echo eX(1, "MXN", "USD"); ?> MXN</b>
							<br>1 USD =<b><?php echo eX(1, "EUR", "USD"); ?> EUR	</b></p>
						</div>
					</div>
  				</div>
  				<div id="money">
